...
import { PlusCircle, Edit, Trash2, Search, Redo2, Calendar as CalendarIcon, MinusCircle } from 'lucide-react';
...
const initialSaleReturnNotes: SaleReturnNote[] = [
  { 
    ...
    items: [
      { id: 'item1', productId: '3', productName: '27-inch Monitor', quantity: 1, unitPrice: 250, taxRateId: 'rate3', taxAmount: 45, totalAmount: 295 },
    ],
    subTotal: 250,
    discountAmount: 0,
    totalTaxAmount: 45,
