...
import { PlusCircle, Search, FileDown, ChevronsUpDown, Pencil, Trash2, CalendarIcon, X } from 'lucide-react';
    ...
    <div className="container mx-auto">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold">{t('journalVouchers')}</h1>
          <Dialog>
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="relative w-full max-w-sm">
            ...
            <Input
              placeholder={`${t('search')} by Voucher # or Narration`}
              value={searchTerm}
