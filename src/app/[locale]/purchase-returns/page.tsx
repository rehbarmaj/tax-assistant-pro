...
import type { PurchaseReturnNote } from '@/lib/types';
import { initialPurchaseReturnNotes } from '@/lib/mock-data';
...
const PurchaseReturnsPage: NextPage = () => {
  ...
  const [notes, setNotes] = useState<PurchaseReturnNote[]>(initialPurchaseReturnNotes);
    ...
    <div className="container mx-auto">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold">{t('purchaseReturns')}</h1>
          <Dialog>
            <DialogTrigger asChild>
              <Button>
                <PlusCircle className="mr-2" /> Add Purchase Return
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-5xl">
              <DialogHeader>
                <DialogTitle>New Purchase Return Note</DialogTitle>
              </DialogHeader>
              {/* Add form here */}
              <DialogFooter>
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="relative w-full max-w-sm">
            ...
            <Input
              placeholder={`${t('search')} by Note # or Supplier`}
              value={searchTerm}
